...
//두번째 이슈1- 내 아이디 갤러리나 사용자 아이디를 클릭해서 출력하는 user 타입의 갤러리 랜더링시에는 사용자 아이디를 클릴할때마다 중복 데이터 호출이  일어나기 떄문에 해당 문제점을 해결하기 위해서 user타입의 갤러리가 랜더링될때에만 state값 변경하고 state에 따라서 사용자 아이디의 클릭 이벤트를 막음으로서 불필요한 서버 데이터 호출을 방지했다.
